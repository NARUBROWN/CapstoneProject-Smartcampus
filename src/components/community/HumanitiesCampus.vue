...
export default {
  name: "HumanitiesCampus",
  components: {
    WriteButton
  },
  data() {
    return {
      table: 'CampusBoard_Human',
      contents: [{
        id: null,
        title: null,
        user: null,
  ...
  created() {
    ...
    this.writePermission = this.$store.getters.getUserStore.department === "인문사회계열" || this.$store.getters.getUserStore.stu_rank === "관리자";
  },
  methods: {
    inValues(a) {
